    ...
    variants.forEach((variant) => {
        ...
        const theme = {
            ...
            colors: {
                ...
                'editorGutter.addedBackground': getForeground(90),
                'editorGutter.deletedBackground': getForeground(90),
                'editorGutter.modifiedBackground': getForeground(90),
                'editorIndentGuide.background': getForeground(100),
                'editorLineNumber.foreground': getForeground(75),
                'editorRuler.foreground': getForeground(70),
